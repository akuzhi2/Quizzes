...
public class GreatWhiteShark extends JPanel
{
    Location l = new Location();   
    public GreatWhiteShark() throws IOException, URISyntaxException
    {
        String s = l.switchSlash();
        s = s.substring(0, 45);
        Color news = Color.decode("#73a1a2");
        setBackground(news);
        ImageIcon imageIcon = new ImageIcon(s + "/photos/whiteshark.jpg");
